...
function LoadingFallback() {
  return (
    <div className="max-w-md w-full mx-4 text-center">
      <div className="w-24 h-24 bg-[#007A5E]/20 rounded-full flex items-center justify-center mx-auto mb-8 animate-pulse" />
      <div className="h-10 bg-[#007A5E]/20 rounded-xl mb-4 animate-pulse" />
      <div className="h-6 bg-[#007A5E]/10 rounded-lg animate-pulse" />
    </div>
  );
}
